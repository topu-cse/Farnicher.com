...
const Shop = () => {
    ...
    return (
        <div className='mb-[100px]'>
            ...
            <h1 className='text-center mt-8 font-bold text-2xl '>Our Products</h1>

            <div className='max-w-[1640] mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-10 px-[20px]  lg:px-[100px] '>
                {
                    exploreData.map((e) => (
                        <Link to={'/cart'}>
